...
def gbif_accepted(parameter_value: bool, path: str, response: Dict[str,any]) -> bool:
	for record in get_gbif_records(path, response):
...
def count_only(parameter_value: bool, path: str, response: Dict[str,any]) -> bool:
	pass


parameter_constraints: dict[str, Callable[[bool, str, Dict[str,any]], bool]] = {
